...
This script audits a Bitbucket repository to assess what needs to be migrated.
It generates a comprehensive report including:
- Issue and PR counts and number gaps
- User account mappings needed
...
Authentication:
    Use a user-level API Token (NOT Repository Access Token)
    Create at: Settings > Atlassian account settings > Security > API tokens
    Required permissions: Read access to repositories, pull requests, and issues
